# PositonMover is a module to manage the :position
...
# fucntionality and better performance.
module PositionMover

  # <tt>move_to_position</tt> is an instance method that
  # will move a list item to a new position, but also
  # increment/decrementthe positions of other list items
  # as necessary.
  #
  # Send nil as the value for a new_position to remove
  ...
  # should be able to to have a page at position 1.
  #
